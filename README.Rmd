...
<br> **Description**: A manually curated arsenic functional gene database (AsgeneDB) and R package (Asgene package) are developed for rapid and accurate metagenomic analysis.<br> 
...
### Output
##### Output 1
```{r results1, echo=FALSE, fig.cap="Output of As metabolic gene abundance analysis", out.height="10%",out.width = '20%'}
knitr::include_graphics("/Users/xinweisong/Desktop/results1.png")
```
##### Output 2
```{r results2, echo=FALSE, fig.cap="Output of As metabolic taxonomy analysis", out.height="10%",out.width = '20%'}
knitr::include_graphics("/Users/xinweisong/Desktop/results2.png")
```

#### **NOTE:**
* You need to place a tab-separated file in your working path that contains the sample name and the number of sequences. Note that file extensions should not be included here.  For example: <https://data.cyverse.org/dav-anon/iplant/home/xinwei/AsgeneDB/sampleinfo.txt>
